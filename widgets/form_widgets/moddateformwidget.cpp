...
ModDateFormWidget::ModDateFormWidget(QWidget *parent) :
...
void ModDateFormWidget::setFieldName(const QString &name)
{
    m_fieldNameLabel->setText(name);
}

QString ModDateFormWidget::getFieldName() const
{
    return m_fieldNameLabel->text();
}

void ModDateFormWidget::clearData()
{
    m_lineEdit->clear();
}

void ModDateFormWidget::setData(const QVariant &data)
{
    if (!data.isNull()) {
...
QVariant ModDateFormWidget::getData() const
{
    return m_dateTime;
}

void ModDateFormWidget::loadMetadataDisplayProperties(const QString &metadata)
{
...
void ModDateFormWidget::validateData()
{
    //always valid
    emit dataEdited();
}
...
void ModDateFormWidget::setupFocusPolicy()
{
